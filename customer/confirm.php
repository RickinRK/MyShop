...
<h1 align="center"> Por Favor, confirme o pagamento! </h1>
...
<label>Selecione a froma de pagamento:</label>
...
<label>Transação/Codigo de referencia:</label>
...
echo "<script>alert('Recebemos seu pagamento e ate 24hrs o seu pedido esta processado!')</script>";
