...
<strong> Aviso! </strong> Por favor confirme seu email. Caso não tenha recebido nada, clique em
...
$subject = "Email de confirmação - MyShop";
...
echo "<script>alert('Um email de confirmação foi enviado a você!')</script>";
