...
<p class="lead"> Seus pedidos em um so lugar!</p>
...
<td>
<a href="confirm.php?order_id=<?php echo $order_id; ?>" target="blank" class="btn btn-success btn-xs" > Confirme se você ja pagou </a>
</td>
