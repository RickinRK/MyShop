...
echo "<script>alert('Esse produto ja foi adicionado no carrinho.')</script>";
...
<label class="col-md-5 control-label" >Quantidade de produtos </label>
...
<label class="col-md-5 control-label" >Quantidade de pacotes </label>
...
echo "<script>alert('Você precisa estar logado para adicionar a lista de desejos!')</script>";
...
echo "<script>alert('Adicionado a sua lista de desejos!')</script>";
...
echo "<script> alert('Produto adicionado a lista de desejos!') </script>";
...
<h3 class="text-center"> Você talvez goste: 3 produtos perfeitos para voce! </h3>
...
<a href='$pro_url' class='btn btn-default' >Ver detalher</a>
