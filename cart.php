...
<p class="text-muted" > Você tem <?php echo $count; ?> item(s) em seu carrinho. </p>
...
Ir para o pagamento <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('Esse cupom expirou!')</script>";
...
echo "<script> alert('Seu cumpom não é valido!') </script>";
...
<h3 class="text-center"> Voce talvez goste... </h3>
...
<p class="text-muted">
Os custos de envio e adicionais são calculados com base nos valores gastos.
</p>
