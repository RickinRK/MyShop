...
Seguir para o pagamento <i class="fa fa-chevron-right"></i>
...
echo "<script> alert('Esse cupom não é valido.') </script>";
...
<h3 class="text-center"> Produtos que você deve gostar... </h3>
