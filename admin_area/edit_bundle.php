...
<i class="fa fa-dashboard"> </i> Dashboard / Editar pacotes
...
<i class="fa fa-money fa-fw"></i> Editar pacote
...
Exemplo de URL : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Selecione a Marca: </label>
...
<label class="col-md-3 control-label" > Tabelas </label>
...
<label class="col-md-3 control-label" > Etiqueta do produto </label>
...
echo "<script> alert('Pacote foi alterado com sucesso!') </script>";
