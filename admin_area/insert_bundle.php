...
<i class="fa fa-dashboard"> </i> Painel / Inserir Pacote
...
<i class="fa fa-money fa-fw"></i> Inserir Pacote
...
<label class="col-md-3 control-label" > Titulo do Pacote </label>
...
<label class="col-md-3 control-label" > Selecione uma Marca </label>
...
<option> Selecione uma categoria de produto </option>
...
<label class="col-md-3 control-label" > Imagem 1 </label>
...
<label class="col-md-3 control-label" > Imagem 2 </label>
...
<label class="col-md-3 control-label" > Imagem 3 </label>
...
<label class="col-md-3 control-label" > Preço de Venda </label>
...
<label class="col-md-3 control-label" > Palavras-Chave </label>
...
<a data-toggle="tab" href="#description"> Descrição </a>

</li>

<li>

<a data-toggle="tab" href="#features"> Especificações </a>
...
<label class="col-md-3 control-label" > Etiqueta do Pacote </label>
