...
<label class="col-md-3 control-label"> Desconto do Cupom </label>
...
<label class="col-md-3 control-label"> Limite de cupons </label>
...
<label class="col-md-3 control-label"> Selecione o produto valido no cupom: </label>
...
<option>Selecione o cupom do produto</option>
...
echo "<script>alert('Um cupom foi alterado!')</script>";
