...
<i class="fa fa-dashboard"></i> Painel / Editar Categoria do Produto
...
<i class="fa fa-money fa-fw" ></i> Editar Categoria do Produto
...
<label class="col-md-3 control-label" > Selecione uma imagem: </label>
...
echo "<script>alert('Categoria do produto alterada!')</script>";
