...
<i class="fa fa-dashboard"></i> Painel / Inserir Relação
...
<label class="col-md-3 control-label"> Titulo da Relação  </label>
...
echo "<script>alert('Nova relação foi inserida!')</script>";
