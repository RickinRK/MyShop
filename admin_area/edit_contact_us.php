...
<i class="fa fa-dashboard" ></i> Dashboard / Editar Fale Conosco
...
<i class="fa fa-money fa-fw"></i> Editar Fale Conosco  
...
<label class="col-md-3 control-label"> Email de contato: </label>
...
echo "<script>alert('`Pagina: 'Fale conosco' alterada)</script>";
