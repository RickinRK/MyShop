...
<i class="fa fa-dashboard"></i> Painel / Editar Marca
...
<label class="col-md-3 control-label"> Selecionar Logo </label>
...
<input type="submit" name="update" class="form-control btn btn-primary" value=" Atualizar Marca " >
...
echo "<script>alert('Uma marca foi alterada!')</script>";
