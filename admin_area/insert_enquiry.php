...
<i class="fa fa-dashboard" ></i> Painel / Inserir Tipo de Consulta
...
<i class="fa fa-money fa-fw"></i> Inserir Tipo de Consulta 
...
<label class="col-md-3 control-label"> Titulo de Consulta </label>
...
echo "<script> alert('Novo tipo de consulta foi inserido') </script>";
