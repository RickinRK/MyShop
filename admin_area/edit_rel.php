...
<i class="fa fa-dashboard"></i> Painel / Editar Relaçoes
...
<i  class="fa fa-money fa-fw"></i> Editar relação
...
<label class="col-md-3 control-label"> Selecione o Produto  </label>
...
<label class="col-md-3 control-label"> Selecionar Bundle  </label>
...
echo "<script>alert('Relação foi alterada!')</script>";
