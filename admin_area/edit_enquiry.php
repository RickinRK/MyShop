...
<i class="fa fa-dashboard" ></i> Painel / Editar Consulta
...
<i class="fa fa-money fa-fw"></i> Editar tipo de Consulta 
...
echo "<script>alert('Um tipo de requisição foi alterado!')</script>";
