...
<i class="fa fa-dashboard" ></i> Painel / Editar Loja
...
<i class="fa fa-money fa-fw"></i> Editar Loja
...
<label class="col-md-3 control-label"> Imagem Loja : </label>
...
echo "<script>alert('Uma coluna da loja foi alterada!')</script>";
