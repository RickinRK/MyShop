...
<i class="fa fa-dashboard" ></i> Painel / Inserir Loja
...
<i class="fa fa-money fa-fw"></i> Inserir Loja
...
<label class="col-md-3 control-label"> Titulo da loja : </label>
...
<label class="col-md-3 control-label"> Descrição de loja : </label>
...
<label class="col-md-3 control-label"> Botão loja : </label>
...
echo "<script>alert('Você já inseriu 3 colunas de loja')</script>";
...
echo "<script>alert('Nova coluna da loja adicionada!')</script>";
