...
<i class="fa fa-dashboard" ></i> Painel / Inserir USER
...
<i class="fa fa-money fa-fw" ></i> Inserir Usuarios
...
<label class="col-md-3 control-label">Email do usuario: </label>
...
<label class="col-md-3 control-label">Senha do usuario: </label>
...
<label class="col-md-3 control-label">Pais do usuario: </label>
...
<label class="col-md-3 control-label">Contato do Usuario: </label>
...
<label class="col-md-3 control-label">Sobre o usuario: </label>
...
<label class="col-md-3 control-label">Imagem do usuario: </label>
...
echo "<script>alert('Um usuario foi inserido com sucesso!')</script>";
