...
<i class="fa fa-dashboard" ></i> Painel / Editar pagina: Sobre nós
...
<i class="fa fa-money fa-fw"></i> Editar pagina: Sobre nós
...
<label class="col-md-3 control-label"> Breve descrição: </label>
...
echo "<script>alert('Pagina: 'Sobre nos' alterada!)</script>";
