  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Esqueci</span> minha senha
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<h3>  Digite seu email abaixo e enviaremos sua senha!</h3>
...
echo "<script> alert('Esse email não esta cadastrado!') </script>";
...
<h1 align='center'> Sua senha foi enviada! </h1>
...
echo "<script> alert('Sua senha foi enviada em seu email!') </script>";
