  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Registrar-se</span> 
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<i class="fa fa-user-md"></i> Cadastrar
...
function check_pass() {
 ...
 if(val!="")
 {
// se o tamanho da senha for menor ou = 6
  if(val.length<=6)no=1;

 // Se o comprimento da senha for maior que 6 e contiver letras minúsculas, números ou caracteres especiais
  if(val.length>6 && (val.match(/[a-z]/) || val.match(/\d+/) || val.match(/.[!,@,#,$,%,^,&,*,?,_,~,-,(,)]/)))no=2;

  // Se o comprimento da senha for maior que 6 e conter alfabeto, número e caractere especial, respectivamente
  if(val.length>6 && ((val.match(/[a-z]/) && val.match(/\d+/)) || (val.match(/\d+/) && val.match(/.[!,@,#,$,%,^,&,*,?,_,~,-,(,)]/)) || (val.match(/[a-z]/) && val.match(/.[!,@,#,$,%,^,&,*,?,_,~,-,(,)]/))))no=3;

  // Se o comprimento da senha for maior que 6 e deve conter letras, números e caracteres especiais
...
echo "<script>alert('Esse email ja tem uma conta vinculada! Tente outro!')</script>";
...
$subject = "Mensagem de confirmação de email";

$from = "henrilopes2006@gmail.com";

$message = "

<h2>
Confirmação de email - MyShop $c_name
</h2>
